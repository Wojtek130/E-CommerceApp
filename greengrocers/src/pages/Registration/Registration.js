...
const Registration = () => {
  ...
  return (
    <div className="form__wrapper">
      <form
        className={hide ? "registration_form" : "registration_form hide"}
        onSubmit={handleSubmit}
      >
        <p className="registration_form__message">
          Dear customer!
          <br />
        ...
        <input
          className="registration_form__submit btn"
          type="submit"
          value="Submit"
        />
      </form>
      <p className={hide ? "hide" : undefined}>
        {message}
        <br /> Go to <a href="/login">login page?</a>
      </p>
    </div>
  );
};
